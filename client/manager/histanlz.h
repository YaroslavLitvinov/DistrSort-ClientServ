...
alloc_range_request_analize_histograms( struct file_records_t *records,
		const int single_src_items_count, pid_t pid, const struct Histogram *histograms_array, size_t len );

void
request_assign_detailed_histogram( struct file_records_t *records,
		int current_histogram_len, int single_src_items_count, int node_id,
